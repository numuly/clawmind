...
| | |
|---|---|
| 🫀 Health-Driven | Multi-signal: success + progress + momentum − fail penalty |
...
| 0.4–0.7 | 🟡 Okay | Focus on current step |
| < 0.4 | 🔴 Danger | Break into smallest units |
...
[Download mind.skill ↗](https://github.com/numuly/mind/releases/latest) · Install via [ClawHub](https://clawhub.ai)
